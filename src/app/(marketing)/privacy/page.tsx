      ...
      <section className="section">
        <div className="container max-w-[760px] mx-auto">
          <div className="reveal text-[15px] text-ink-mid leading-[1.8] space-y-8">
            ...
            <div>
              <h3 className="font-display font-bold text-[19px] text-ink-strong mb-2">What we collect</h3>
              <p>
            ...
            <div>
              <h3 className="font-display font-bold text-[19px] text-ink-strong mb-2">How we use it</h3>
              <p>
            ...
            <div>
              <h3 className="font-display font-bold text-[19px] text-ink-strong mb-2">Third parties</h3>
              <p>
            ...
            <div>
              <h3 className="font-display font-bold text-[19px] text-ink-strong mb-2">Cookies</h3>
              <p>
            ...
            <div>
              <h3 className="font-display font-bold text-[19px] text-ink-strong mb-2">Data retention</h3>
              <p>
            ...
            <div>
              <h3 className="font-display font-bold text-[19px] text-ink-strong mb-2">Your rights</h3>
              <p>
