      ...
      <section className="section">
        <div className="container max-w-[760px] mx-auto">
          <div className="reveal text-[15px] text-ink-mid leading-[1.8] space-y-8">
            ...
            <div>
              <h3 className="font-display font-bold text-[19px] text-ink-strong mb-2">Acceptance</h3>
              <p>
            ...
            <div>
              <h3 className="font-display font-bold text-[19px] text-ink-strong mb-2">Your account</h3>
              <p>
            ...
            <div>
              <h3 className="font-display font-bold text-[19px] text-ink-strong mb-2">Subscriptions & billing</h3>
              <p>
            ...
            <div>
              <h3 className="font-display font-bold text-[19px] text-ink-strong mb-2">Educational content only</h3>
              <p>
            ...
            <div>
              <h3 className="font-display font-bold text-[19px] text-ink-strong mb-2">Acceptable use</h3>
              <p>
            ...
            <div>
              <h3 className="font-display font-bold text-[19px] text-ink-strong mb-2">Termination</h3>
              <p>
            ...
            <div>
              <h3 className="font-display font-bold text-[19px] text-ink-strong mb-2">Changes to these terms</h3>
              <p>
            ...
            <div>
              <h3 className="font-display font-bold text-[19px] text-ink-strong mb-2">Contact</h3>
              <p>
