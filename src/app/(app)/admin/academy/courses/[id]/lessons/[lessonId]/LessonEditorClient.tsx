    ...
    <div className="flex flex-col gap-5">
      ...
      <div className="rounded-2xl p-4 flex flex-wrap items-center gap-4 bg-panel shadow-md">
        <div className="flex-1 min-w-[200px] flex flex-col gap-1">
          ...
          <input
            className="rounded-xl px-3 py-2 text-base sm:text-[14px] font-semibold outline-none transition-shadow focus:ring-2 focus:ring-teal-deep bg-panel-2 text-ink-strong"
        ...
        <div className="flex flex-col gap-1">
          ...
          <input
            className="rounded-xl px-3 py-2 text-base sm:text-[13.5px] outline-none w-24 transition-shadow focus:ring-2 focus:ring-teal-deep bg-panel-2 text-ink-strong"
            placeholder="18 min"
        ...
        <div className="flex flex-col gap-1">
          ...
          <input
            className="rounded-xl px-3 py-2 text-base sm:text-[13.5px] outline-none w-48 transition-shadow focus:ring-2 focus:ring-teal-deep bg-panel-2 text-ink-strong"
            placeholder="https://…"
      ...
      <div className="rounded-2xl overflow-hidden bg-panel shadow-md">
        ...
        {tab === "edit" ? (
          <textarea
            className="w-full outline-none resize-none text-base sm:text-[13px] p-5 min-h-[600px] leading-[1.7] bg-panel text-ink-strong"
