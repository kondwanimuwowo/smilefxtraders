...
const SESSION_GUIDE = [
  ...
  },
  {
    ...
    ringCls: "shadow-ring-gold-2",
    bgCls:   "bg-gold-tint-soft",
  ...
  },
  {
    ...
    ringCls: "shadow-ring-teal-2",
    bgCls:   "bg-teal-tint-soft",
  ...
  },
  {
    ...
    ringCls: "shadow-ring-coral-2",
    bgCls:   "bg-coral-tint-soft",
