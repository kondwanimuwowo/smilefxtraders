...
export async function POST(
  ...
  try {
    ...
    // Same foreign-key trap as the like route: commenting on a post that was
    // deleted while the feed sat open threw P2003 as a 500.
    ...
    return handleApiError("community/comments", err);
  }
}
