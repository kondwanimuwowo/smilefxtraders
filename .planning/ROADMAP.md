...
Plans:
- [ ] 01-01: SignalBars SVG component + signalCfg brightness-variant mapping + icon-only signal on cards + color key
- [ ] 01-02: Merge summary strip and filter tabs into one interactive pill row
